...
class Qwen3CoderToolParser(ToolParser):
    ...
    def extract_tool_calls_streaming(
        ...
        if self.in_function:
            ...
            # Accumulate json_fragments into combined. Do NOT early-return here.
            # With MTP speculative decoding, a single delta can bundle the last
            # parameter value AND </function>. If the close check ran first it would emit
            ...
            if not self.json_closed and self.function_end_token in tool_text:
                ...
                if func_content_end != -1:
                    ...
                    # When parse failed, prev_tool_call_arr still has "{}" placeholder.
                    # Restore from incrementally streamed args + closing brace.
                    if (
                ...
                # Append "}" to combined and fall through to unified emit
                combined += "}"
                self.in_function = False
                self.json_closed = True
                self.accumulated_params = {}
